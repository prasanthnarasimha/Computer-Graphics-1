...
function disableAlldivs(){
    ...
    document.getElementById('cube3d').style.display = 'none';
...
function showdiv(id){
    ...
    if(id == 'cube3d'){
        document.getElementById('pview').style.marginTop = "20px"
    } else{
        document.getElementById('pview').style.marginTop = "500px"
